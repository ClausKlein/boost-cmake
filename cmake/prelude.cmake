...
include(${CMAKE_CURRENT_LIST_DIR}/enable-experimental-import-std.cmake)
...
if(
    ...
    if(APPLE)
        ...
        set(CMAKE_CXX_STDLIB_MODULES_JSON ${LLVM_DIR}/lib/c++/libc++.modules.json)
    elseif(LINUX)
        set(ENV{CXXFLAGS} "-stdlib=libc++ -U_FORTIFY_SOURCE -D_FORTIFY_SOURCE=0")
        message(STATUS "CXXFLAGS=$ENV{CXXFLAGS}")
    ...
    if(EXISTS ${CMAKE_CXX_STDLIB_MODULES_JSON})
        ...
        message(WARNING "File does NOT EXISTS! ${CMAKE_CXX_STDLIB_MODULES_JSON}")
    endif()
endif()
