...
set(PACKAGE_PROJECT_ROOT_PATH "${CMAKE_CURRENT_LIST_DIR}" CACHE INTERNAL "The path to the PackageProject directory")
...
function(packageProject)
  ...
  if(DEFINED PROJECT_NAMESPACE)
    ...
    foreach(PROJECT_TARGET IN LISTS PROJECT_TARGETS)
      add_library(${PROJECT_NAMESPACE}${PROJECT_TARGET} ALIAS ${PROJECT_TARGET})
    endforeach()
  endif()
  ...
  if(DEFINED PROJECT_VERSION_HEADER OR DEFINED PROJECT_EXPORT_HEADER)
    ...
    if(DEFINED PROJECT_VERSION_HEADER)
      ...
      configure_file(
        ${PACKAGE_PROJECT_ROOT_PATH}/version.h.in ${PROJECT_VERSION_INCLUDE_DIR}/${PROJECT_VERSION_HEADER} @ONLY
      )
    endif()
    ...
    foreach(PROJECT_TARGET IN LISTS PROJECT_TARGETS)
      ...
      target_include_directories(${PROJECT_TARGET} ${VISIBILITY} "$<BUILD_INTERFACE:${PROJECT_VERSION_INCLUDE_DIR}>")
    endforeach()
  ...
  install(TARGETS ${PROJECT_TARGETS}
          ...
          LIBRARY DESTINATION ${CMAKE_INSTALL_LIBDIR}/${PROJECT_NAME}${PROJECT_VERSION_SUFFIX}
                  COMPONENT "${PROJECT_NAME}_Runtime" NAMELINK_COMPONENT "${PROJECT_NAME}_Development"
  ...
  set("${PROJECT_NAME}_INSTALL_CMAKEDIR" "${CMAKE_INSTALL_LIBDIR}/cmake/${PROJECT_NAME}${PROJECT_VERSION_SUFFIX}"
  ...
  install(EXPORT ${PROJECT_NAME}Targets DESTINATION "${${PROJECT_NAME}_INSTALL_CMAKEDIR}" NAMESPACE ${PROJECT_NAMESPACE}
          COMPONENT "${PROJECT_NAME}_Development"
  )

  install(FILES "${PROJECT_BINARY_DIR}/${PROJECT_NAME}ConfigVersion.cmake"
                "${PROJECT_BINARY_DIR}/${PROJECT_NAME}Config.cmake" DESTINATION "${${PROJECT_NAME}_INSTALL_CMAKEDIR}"
          COMPONENT "${PROJECT_NAME}_Development"
  )
