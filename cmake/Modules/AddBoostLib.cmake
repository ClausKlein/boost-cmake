function(_add_boost_lib)
    ...
    set_target_properties(
        ${BOOSTLIB_NAME}
        PROPERTIES OUTPUT_NAME "boost_${BOOSTLIB_NAME}" FOLDER "Boost"
    )
    ...
    elseif(PROJECT_IS_TOP_LEVEL AND NOT BOOST_BUILD_ALL)
        target_compile_options(
            ${BOOSTLIB_NAME}
            PRIVATE -Wall -Wextra -Wpedantic -Werror -Wshadow
        )
    else()
    ...
    if(BOOSTLIB_DEFINE_PRIVATE)
        target_compile_definitions(
            ${BOOSTLIB_NAME}
            PRIVATE ${BOOSTLIB_DEFINE_PRIVATE}
        )
    endif()
    if(BOOSTLIB_CXXFLAGS_PRIVATE)
        target_compile_options(
            ${BOOSTLIB_NAME}
            PRIVATE ${BOOSTLIB_CXXFLAGS_PRIVATE}
        )
    endif()
    if(BOOSTLIB_INCLUDE_PRIVATE)
        target_include_directories(
            ${BOOSTLIB_NAME}
            PRIVATE ${BOOSTLIB_INCLUDE_PRIVATE}
        )
    endif()
endfunction()
